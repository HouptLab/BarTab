...
let proj_code = null;
let auth=null;
let firebase_directory = "archive";
           ...
           // firebase will tell us if we are already logged in, or not
                ...
                $firebaseAuth().$onAuthStateChanged(function(firebaseUser) {
                  ...
                  if (firebaseUser) {
                    ...
                    sessionStorage.setItem("bartabPageRequestedLogin","archive");
...
app.controller("archiveCtrl", ["$scope", "exptDataAuthFunction", 
...
// --------------------------------------------------------------------------------
		...
		function isValidProjectExpt(expt) {
		
		    return (
		    "undefined" != typeof(expt.name)  && null != expt.name 
		    && "undefined" != typeof(expt.wikipage)  && null != expt.wikipage
		    && "undefined" != typeof(expt.investigators)  && null !=  expt.investigators
		    && "undefined" != typeof(expt.last_updated)  && null !=  expt.last_updated
		    );
	...
	function setProjects() {
		...
		for (let expt_code in $scope.projects.expts) {
		    if (null != $scope.projects.expts[expt_code].archived) {
                ...
                if (isValidProjectExpt($scope.projects.expts[expt_code])) {
                    ...
                    console.log(expt_code," is not valid expt");
                    // TODO: put up an alert
                }
            }
